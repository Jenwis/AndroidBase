...
public class LayoutAnimation {
            ...
            if (type == AnimationType.HORIZON_CROSS) {
                ...
                for (int i = 0; i < group.getChildCount(); i++) {
                    bindAnimation(group.getChildAt(i), depth + 1,
                            i % 2 == 0 ? AnimationType.HORIZON_LEFT : AnimationType.HORIZON_RIGHT);
                }
            } else {
                for (int i = 0; i < group.getChildCount(); i++) {
    ...
    private void runHorizonLeftAnimation(View view, long delay) {
        ...
        ObjectAnimator objectAnimator
                = ObjectAnimator.ofFloat(view, "translationX", -UIUtils.getScreenWidth(), 0);
    ...
    private void runHorizonRightAnimation(View view, long delay) {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(view,
                "translationX", UIUtils.getScreenWidth(), 0);
        objectAnimator.setInterpolator(new LinearInterpolator());
        ObjectAnimator objectAnimatorAlpha = ObjectAnimator.ofFloat(view, "alpha", 0f, 1f);
        AnimatorSet set = new AnimatorSet();
        set.setStartDelay(delay);
    ...
    public enum AnimationType {
        ALPHA, ROTATE, HORIZON_LEFT, HORIZON_RIGHT, HORIZON_CROSS, SCALE, FLIP_HORIZON, FLIP_VERTICAL
    }
}
